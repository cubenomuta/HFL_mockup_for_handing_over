...
def start_grpc_server(  # pylint: disable=too-many-arguments
    ...
    **SSL**
    ...
    ----------
    fog_manager : FogManager
        Instance of FogManager
    server_address : str
        Server address in the form of HOST:PORT e.g. "[::]:8080"
    max_concurrent_workers : int
        Maximum number of fogs the server can process before returning
    ...
    keepalive_time_ms : int
        ...
        - https://github.com/grpc/proposal/blob/master/A8-fog-side-keepalive.md
        - https://github.com/grpc/grpc/blob/master/doc/keepalive.md
        - https://grpc.io/docs/guides/performance/
        Mobile Flower fogs may choose to increase this value if their server
    ...
    options = [
        ...
        # compatibility with popular cloud providers. Mobile Flower fogs may
    ...
    servicer = FlowerServiceServicer(fog_manager)
    add_FlowerServiceServicer_to_server(servicer, server)
    ...
    if certificates is not None:
        ...
        server_credentials = grpc.ssl_server_credentials(
            ...
            # A boolean indicating whether or not to require fogs to be
