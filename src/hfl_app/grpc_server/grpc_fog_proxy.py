...
# ==============================================================================
"""gRPC-based Flower FogProxy implementation."""
...
class GrpcFogProxy(FogProxy):
    """Flower fog proxy which delegates over the network using gRPC."""
    ...
    def get_properties(
        ...
        """Requests fog's set of internal properties."""
    ...
    def fit(
        ...
        fog_msg: ClientMessage = res_wrapper.fog_message
        fit_res = serde.fit_res_from_proto(fog_msg.fit_res)
    ...
    def reconnect(
        ...
        fog_msg: ClientMessage = res_wrapper.fog_message
        disconnect = serde.disconnect_res_from_proto(fog_msg.disconnect_res)
        return disconnect
